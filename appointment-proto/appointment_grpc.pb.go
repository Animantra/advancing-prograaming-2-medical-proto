...
const (
	AppointmentService_CreateAppointment_FullMethodName       = "/tutorial.AppointmentService/CreateAppointment"
	AppointmentService_GetAppointment_FullMethodName          = "/tutorial.AppointmentService/GetAppointment"
	AppointmentService_ListAppointments_FullMethodName        = "/tutorial.AppointmentService/ListAppointments"
	AppointmentService_UpdateAppointmentStatus_FullMethodName = "/tutorial.AppointmentService/UpdateAppointmentStatus"
)
...
type AppointmentServiceClient interface {
	...
	ListAppointments(ctx context.Context, in *ListAppointmentRequest, opts ...grpc.CallOption) (*ListAppointmentsResponse, error)
...
func (c *appointmentServiceClient) ListAppointments(ctx context.Context, in *ListAppointmentRequest, opts ...grpc.CallOption) (*ListAppointmentsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AppointmentServiceServer interface {
	...
	ListAppointments(context.Context, *ListAppointmentRequest) (*ListAppointmentsResponse, error)
...
func (UnimplementedAppointmentServiceServer) ListAppointments(context.Context, *ListAppointmentRequest) (*ListAppointmentsResponse, error) {
...
func _AppointmentService_ListAppointments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AppointmentServiceServer).ListAppointments(ctx, req.(*ListAppointmentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AppointmentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "tutorial.AppointmentService",
