...
const file_proto_appointment_proto_rawDesc = "" +
	"\n" +
	"\x17proto/appointment.proto\x12\btutorial\"o\n" +
	...
	"\x18ListAppointmentsResponse\x12A\n" +
	"\fappointments\x18\x01 \x03(\v2\x1d.tutorial.AppointmentResponseR\fappointments2\xf1\x02\n" +
	"\x12AppointmentService\x12V\n" +
	"\x11CreateAppointment\x12\".tutorial.CreateAppointmentRequest\x1a\x1d.tutorial.AppointmentResponse\x12P\n" +
	"\x0eGetAppointment\x12\x1f.tutorial.GetAppointmentRequest\x1a\x1d.tutorial.AppointmentResponse\x12X\n" +
	"\x10ListAppointments\x12 .tutorial.ListAppointmentRequest\x1a\".tutorial.ListAppointmentsResponse\x12W\n" +
	"\x17UpdateAppointmentStatus\x12\x1d.tutorial.UpdateStatusRequest\x1a\x1d.tutorial.AppointmentResponseBXZVgithub.com/Animantra/advanced-programming-2/assingment1/appointmentservice/proto;protob\x06proto3"
...
var file_proto_appointment_proto_goTypes = []any{
	(*CreateAppointmentRequest)(nil), // 0: tutorial.CreateAppointmentRequest
	(*GetAppointmentRequest)(nil),    // 1: tutorial.GetAppointmentRequest
	(*ListAppointmentRequest)(nil),   // 2: tutorial.ListAppointmentRequest
	(*UpdateStatusRequest)(nil),      // 3: tutorial.UpdateStatusRequest
	(*AppointmentResponse)(nil),      // 4: tutorial.AppointmentResponse
	(*ListAppointmentsResponse)(nil), // 5: tutorial.ListAppointmentsResponse
}
var file_proto_appointment_proto_depIdxs = []int32{
	4, // 0: tutorial.ListAppointmentsResponse.appointments:type_name -> tutorial.AppointmentResponse
	0, // 1: tutorial.AppointmentService.CreateAppointment:input_type -> tutorial.CreateAppointmentRequest
	1, // 2: tutorial.AppointmentService.GetAppointment:input_type -> tutorial.GetAppointmentRequest
	2, // 3: tutorial.AppointmentService.ListAppointments:input_type -> tutorial.ListAppointmentRequest
	3, // 4: tutorial.AppointmentService.UpdateAppointmentStatus:input_type -> tutorial.UpdateStatusRequest
	4, // 5: tutorial.AppointmentService.CreateAppointment:output_type -> tutorial.AppointmentResponse
	4, // 6: tutorial.AppointmentService.GetAppointment:output_type -> tutorial.AppointmentResponse
	5, // 7: tutorial.AppointmentService.ListAppointments:output_type -> tutorial.ListAppointmentsResponse
	4, // 8: tutorial.AppointmentService.UpdateAppointmentStatus:output_type -> tutorial.AppointmentResponse
